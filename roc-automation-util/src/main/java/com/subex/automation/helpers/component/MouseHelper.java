...
public class MouseHelper extends AcceptanceTest {
	...
	/*
	 * public static void mouseOver(WebElement element) throws Exception { try {
	 * Actions action = new Actions(driver);
	 * action.moveToElement(element).perform(); } catch ( Exception e ) {
	...
	public static void mouseOver(WebElement element) throws Exception {
		try {
			Actions action = new Actions(driver);
			action.moveToElement(element, 3, 3).perform();
		} catch (Exception e) {
			FailureHelper.setErrorMessage(e);
			throw e;
		}
