...
public class NrtrdeOutSelection extends PSAcceptanceTest implements SelectItemInterface  {
	...
	public void selectItems(String item) throws Exception{
		...
		SearchGridHelper.gridFilterSearchWithComboBox("procConfigType_gwt_uid_", "NRTRDE Out", "Configuration Type");
