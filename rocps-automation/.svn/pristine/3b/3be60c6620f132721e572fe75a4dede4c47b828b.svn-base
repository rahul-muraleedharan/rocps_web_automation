...
public class TapOutSelection extends PSAcceptanceTest implements SelectItemInterface  {
	...
	public void selectItems(String item) throws Exception{
		...
		SearchGridHelper.gridFilterSearchWithComboBox("procConfigType_gwt_uid_", "Tap Out", "Configuration Type");
