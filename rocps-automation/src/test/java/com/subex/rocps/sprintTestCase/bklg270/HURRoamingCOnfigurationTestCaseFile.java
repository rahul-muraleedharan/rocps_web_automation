  ...
  public class HURRoamingCOnfigurationTestCaseFile extends PSAcceptanceTest {
  ...
  */
  ...
  String workBookName = "TestData.xlsx"; String sheetName =
  "RecordingEntityInformation";
  
  
  @org.testng.annotations.Test( priority = 1, description =
  "HUR Roaming Configuration" ) public void TCHurConfiguration() throws
  Exception { try { HURCONFIGURATION hur = new HURCONFIGURATION( path,
  workBookName, sheetName, "HURRoamingConfiguration");
  hur.newRoamingConfiguration(); } catch ( Exception e ) {
  FailureHelper.reportFailure( e ); throw e; } }
