...
public class ratesheetImport extends PSAcceptanceTest {
	...
	public ratesheetImport() throws Exception {

	}

	public void rateSheet(String Path, String WorkbookName, String sheetName, String testCaseName) throws Exception {
		try {
