...
public class TestCase15 extends PSAcceptanceTest {

	String path = System.getProperty("user.dir") + "\\src\\main\\resources\\";
	String workBookName = "SystemTestCases.xlsx";
	String sheetName = "HotBill-ConsolidateAlways";
	...
	@org.testng.annotations.Test(priority = 17, description = "test bill creation", dependsOnMethods = {
			"verifyAggregationResult" })
	public void createtestBill() throws Exception {
		try {
			TestBill billObj = new TestBill(path, workBookName, sheetName, "TestBill");
			billObj.testBillCreation();
		} catch (Exception e) {
			FailureHelper.setErrorMessage(e);
			throw e;
		}
	...
	@org.testng.annotations.Test(priority = 18, description = "hot bill creation", dependsOnMethods = {
			"createtestBill" })
