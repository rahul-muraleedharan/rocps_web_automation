...
public class RapInSelection extends PSAcceptanceTest implements SelectItemInterface  {
	...
	public void selectItems(String item) throws Exception{
		...
		SearchGridHelper.gridFilterSearchWithComboBox("procConfigType_gwt_uid_", "Rap In", "Configuration Type");
