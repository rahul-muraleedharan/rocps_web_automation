...
public class ReportAndExtDefnAction extends PSAcceptanceTest
{
	protected PSGenericHelper psgenericHelperobj = new PSGenericHelper();

	/* This method is used to click on 'New' action in Reports and Extracts Definition*/
	public void clickNewAction( String clientPartition ) throws Exception
	{
		...
		ElementHelper.waitForElement( GenericHelper.getORProperty( "PS_Detail_reportAndExtDefn_RepExtDetails_xpath" ), searchScreenWaitSec );
	}

	/* This method is used to click on  action in Reports and Extracts Definition*/
