...
public class CrossFxRateSelection extends PSAcceptanceTest implements SelectItemInterface  {
	...
	public void selectItems(String item) throws Exception{
		...
		genericHelperObj.waitforPopupHeaderElement( "Cross Fx Rate Group" );
		dsObj.dataFilterSearchGridComboBox("SearchGrid", "crossFxRateGroup_gwt_uid_", item, "Cross Fx Rate Group" );
