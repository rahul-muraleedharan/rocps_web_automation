...
public class HurOutSelection extends PSAcceptanceTest implements SelectItemInterface  {
	...
	public void selectItems(String item) throws Exception{
		...
		SearchGridHelper.gridFilterSearchWithComboBox("procConfigType_gwt_uid_", "HUR Out", "Configuration Type");
