...
public class TestCase11 extends PSAcceptanceTest {

	String path = System.getProperty("user.dir") + "\\src\\main\\resources\\";
	String workBookName = "SystemTestCases.xlsx";
	String sheetName = "Aggre-CrossPeriod-UsgPerUnit";
	...
	@org.testng.annotations.Test(priority = 3, description = "tariffClass creation", retryAnalyzer = com.subex.rocps.automation.helpers.listener.Retry.class, dependsOnMethods = {
	"createBand" })
