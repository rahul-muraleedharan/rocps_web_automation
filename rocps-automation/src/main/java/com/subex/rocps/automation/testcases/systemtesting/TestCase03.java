...
public class TestCase03 extends PSAcceptanceTest {
	...
	@org.testng.annotations.Test(priority = 5, description = "event identifier creation", retryAnalyzer = com.subex.rocps.automation.helpers.listener.Retry.class, dependsOnMethods = {
			"createTariff" })
	...
	@Test(priority = 12, description = "Create a bill profile", retryAnalyzer = com.subex.rocps.automation.helpers.listener.Retry.class, dependsOnMethods = {
