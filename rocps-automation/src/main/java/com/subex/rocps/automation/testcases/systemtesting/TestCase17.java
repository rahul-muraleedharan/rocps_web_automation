...
public class TestCase17 extends PSAcceptanceTest {

	String path = System.getProperty("user.dir") + "\\src\\main\\resources\\";
	String workBookName = "SystemTestCases.xlsx";
	String sheetName = "Regenerate-Delta";
	...
	@org.testng.annotations.Test(priority = 16, description = "verifying aggregation result")
	...
	@org.testng.annotations.Test(priority = 17, description = "hot bill creation")
	...
	@org.testng.annotations.Test(priority = 21, description = "hot bill creation", dependsOnMethods = {
	...
	@org.testng.annotations.Test(priority = 22, description = "hot bill creation", dependsOnMethods = {
	"createTestBillAction" })
	public void regenrateBill() throws Exception {
		try {
			Bills billObj = new Bills(path, workBookName, sheetName, "HotBill-Regenrate");
			billObj.billAction();
		} catch (Exception e) {
			FailureHelper.setErrorMessage(e);
			throw e;
