...
public class TCInRouteStringMnrCase extends PSAcceptanceTest
{
	String path = System.getProperty( "user.dir" ) + "\\src\\main\\resources\\";

	String workBookName = "FunctionalTestCases.xlsx";
	String sheetName = "InRouteStringMnrCase";
	...
	@org.testng.annotations.Test( priority = 2, enabled = true, description = "Mnr   for In Route String field" )
	public void inRouteStringFieldMnr() throws Exception

	{
		try
		{
			...
			taskObj.fileCollection( path, workBookName, sheetName, "FileSchedule_InRouteStringField", 1 );
			PSCollectedFileSearchHelper collectedFlObj = new PSCollectedFileSearchHelper( path, workBookName, sheetName, "CollectedFileSearch_InRouteStringField" );
	...
	@org.testng.annotations.Test( priority = 3, enabled = true, description = "schedule and verify  Aggregation  for In Route String field" )
	public void inRouteStringField_AggregationResult() throws Exception

	{
		try
		{
			...
			AggregationResult aggrResObj = new AggregationResult( path, workBookName, sheetName, "AggregationResult_InRouteStringField" );
