...
public class TestCase10 extends PSAcceptanceTest {

	String path = System.getProperty("user.dir") + "\\src\\main\\resources\\";
	String workBookName = "SystemTestCases.xlsx";
	String sheetName = "Aggregation-MinUsg";
	...
	@org.testng.annotations.Test(priority = 14, description = "scheduling file collection and verify task status", retryAnalyzer = com.subex.rocps.automation.helpers.listener.Retry.class, dependsOnMethods = {
	...
	@org.testng.annotations.Test(priority = 15, description = "run aggregation master task and verifying task status", retryAnalyzer = com.subex.rocps.automation.helpers.listener.Retry.class, dependsOnMethods = {
