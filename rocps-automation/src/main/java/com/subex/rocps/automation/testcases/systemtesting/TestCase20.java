...
public class TestCase20 extends PSAcceptanceTest {

	String path = System.getProperty("user.dir") + "\\src\\main\\resources\\";
	String workBookName = "SystemTestCases.xlsx";
	String sheetName = "HotBill-DateRange";
	...
	@org.testng.annotations.Test(priority = 17, description = "Test Bill and hot bill creation", dependsOnMethods = {
