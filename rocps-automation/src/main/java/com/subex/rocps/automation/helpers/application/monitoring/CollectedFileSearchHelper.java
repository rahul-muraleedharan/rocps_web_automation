...
public class CollectedFileSearchHelper extends PSAcceptanceTest
{
	...
	public CollectedFileSearchHelper( String path, String workBookName, String sheetName, String testCaseName ) throws Exception
	{
	...
	public CollectedFileSearchHelper( String path, String workBookName, String sheetName, String testCaseName, int occurence ) throws Exception
	{
	...
	public void validationOfCollectedFile() throws Exception
	{
		for ( index = 0; index < colSize; index++ )
		{
			...
			GenericHelper.waitForLoadmask( searchScreenWaitSec );
			boolean isCollectedFilepresern = psGenericHelper.isGridTextValuePresent( "PS_Detail_collectedFl_fileName_textID", fileName, "File Name" );
			assertTrue( isCollectedFilepresern, " This file name " + fileName + " is not collected on" + " 'Collected File Search' screen" );
	...
	private void collectedFileSrchFilter() throws Exception
	{
		...
		System.out.println( " curr dt " + currDt );
