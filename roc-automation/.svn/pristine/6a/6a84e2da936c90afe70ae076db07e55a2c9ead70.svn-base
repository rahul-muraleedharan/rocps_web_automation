...
public class testAccuracy extends ROCAcceptanceTest {
	
	String path = null;
	
	final String fileName = "Zen_TestData.xlsx";
	final String sheetName = "Accuracy";
	
	public testAccuracy() throws Exception {
		try {
	...
	@Test(priority=1, description="data _match _results not matching with Min_Accuracy _percentage")
	public void testMinimumAccuracyNotMatching() throws Exception {
		try {
			// when min accuracy is set to 50% and the data match result accuracy is less than 50%
	...
	@Test(priority=2, description="data _match _results  matching with Min_Accuracy _percentage")
	public void testMinimumAccuracyMatching() throws Exception {
		try {
