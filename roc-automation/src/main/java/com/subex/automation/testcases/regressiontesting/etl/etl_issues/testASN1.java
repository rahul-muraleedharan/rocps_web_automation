...
public class testASN1 extends ROCAcceptanceTest {
	
	String path = null;
	String dataDir = null;
	final String fileName = "ETLIssues_TestData.xlsx";
	final String sheetName = "ASN1";
	final String folderName = "ASN1";
	final String dataLocation = "\\src\\main\\resources\\Data\\ASN1\\";
	final String dataFileName = "ASN1_Data.dat";
	
	public testASN1() throws Exception {
		try {
	...
	public void createUsageGroup() throws Exception {
		try {
			Log4jHelper.logInfo("Running ASN1 ETL Flow");
	...
	public void createStream() throws Exception {
		try {
			...
			FileHelper.deleteFile(applicationOS, destinationDirectory + "ASN1.xml");
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, destinationDirectory, "ASN1.xml", "ASN1.xml", true);
