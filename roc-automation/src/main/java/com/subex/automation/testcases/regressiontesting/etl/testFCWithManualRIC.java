...
public class testFCWithManualRIC extends ROCAcceptanceTest {
	...
	@Test(priority=1, description="File Collection for Manual Record Integrity Check")
	public void testManualRIC()throws Exception
	{
		try {
			...
			fileCollection.setRecordIntegrityCheck(true, false, "10", "100");
			...
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample1.dat", "RIC_Sample3.dat", true);
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample2.dat", "RIC_Sample4.dat", true);
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample3.dat", "RIC_Sample5.dat", true);
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample4.dat", "RIC_Sample6.dat", true);
