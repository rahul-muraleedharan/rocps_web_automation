...
public class testFCWithAutomaticFileSizeCheck extends ROCAcceptanceTest {
	
	private static String path = null;
	final String fileName = "ETLRegression_TestData.xlsx";
	final String sheetName = "AutomaticFileSizeCheck";
	final String dataLocation = "\\src\\main\\resources\\Data\\ASCII";
	final String folderName = "Reference";
	
	public testFCWithAutomaticFileSizeCheck() throws Exception {
		try {
	...
	@Test(priority=1, description="File Collection for Automatic File Size Check")
	public void testManualRIC()throws Exception
	{
		try {
			...
			fileCollection.setRecordIntegrityCheck(false, false, null, null);
			fileCollection.setFileSizeCheck(true, true, null, null);
			...
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample1.dat", "FSC_Sample1.dat", true);
			FileHelper.copyFile(applicationOS, automationPath + dataLocation, dataDir + "/Input/" + folderName, "Data_Load_Sample2.dat", "FSC_Sample2.dat", true);
